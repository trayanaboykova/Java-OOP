package Lesson09_TestDrivenDevelopment.Exercise.src.test.java;

import Lesson09_TestDrivenDevelopment.Exercise.src.main.java.*;
...
public class ChainblockImplTest {
    ...
    public void setUp() {
        ...
        this.transactionOne = (Transaction) new TransactionImpl(1, TransactionStatus.SUCCESSFUL, "Ivan", "Peter", 100);
        this.transactionTwo = (Transaction) new TransactionImpl(2, TransactionStatus.SUCCESSFUL, "Ivan", "Peter", 200);
        this.transactionThree = (Transaction) new TransactionImpl(3, TransactionStatus.SUCCESSFUL, "Peter", "Ivan", 300);
        this.transactionFour = (Transaction) new TransactionImpl(4, TransactionStatus.ABORTED, "Ivan", "Peter", 50);
        this.transactionFive = (Transaction) new TransactionImpl(5, TransactionStatus.FAILED, "Peter", "Ivan", 50);
        this.transactionSix = (Transaction) new TransactionImpl(6, TransactionStatus.FAILED, "Ivan", "Peter", 50);
    }

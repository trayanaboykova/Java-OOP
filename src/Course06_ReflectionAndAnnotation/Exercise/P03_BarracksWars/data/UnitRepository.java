package Course06_ReflectionAndAnnotation.Exercise.P03_BarracksWars.data;
...
public class UnitRepository implements Repository {
    ...
    public void removeUnit(String unitType) {
        ...
        if (amountOfUnits.containsKey(unitType) && amountOfUnits.get(unitType) > 0) {
            int currentNumOfUnites = amountOfUnits.get(unitType);
            amountOfUnits.put(unitType, currentNumOfUnites - 1);
        } else {
